...
const PaymentMethodCard = ({
  ...
  >
    ...
    <div className="w-6 h-6 relative flex-shrink-0">
      <div
        className={`w-5 h-5 rounded-full border-2 absolute top-0.5 left-0.5 ${
...
const GpayIcon = () => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
    <path
      d="M21 11.2734C21.001 10.4557 20.931 9.6394 20.789 8.8335H9.243V13.4549H15.856C15.721 14.193 15.434 14.8966 15.014 15.5233C14.594 16.15 14.048 16.6868 13.411 17.1014V20.1012H17.358C19.669 18.013 21 14.9248 21 11.2734Z"
      fill="#4285F4"
    />
    <path
      d="M9.243 23.0001C12.547 23.0001 15.329 21.9369 17.358 20.1036L13.411 17.1038C12.312 17.8338 10.897 18.2504 9.243 18.2504C6.049 18.2504 3.339 16.1405 2.37 13.2974H-1.696V16.3889C-0.677 18.3762 1.885 20.0469 3.817 21.2143C5.749 22.3818 7.973 23 9.243 23.0001Z"
      fill="#34A853"
    />
    <path
      d="M2.37 13.2964C1.857 11.8065 1.857 10.1931 2.37 8.7033V5.6118H-1.696C-2.554 7.2836 -3 9.1288 -3 10.9998C-3 12.8709 -2.554 14.716 -1.696 16.3879L2.37 13.2964Z"
      fill="#FBBC04"
    />
    <path
      d="M9.243 3.7505C10.989 3.7226 12.676 4.3691 13.94 5.5504L17.434 2.1256C15.218 0.0859 12.283 -1.034 9.243 -0.9992C7.973 -0.9991 5.749 -0.3808 3.817 0.7866C1.885 1.9541 -0.677 3.6247 -1.696 5.6121L2.37 8.7036C3.339 5.8604 6.049 3.7505 9.243 3.7505Z"
      fill="#EA4335"
    />
  </svg>
);
