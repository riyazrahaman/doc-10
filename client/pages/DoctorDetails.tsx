  ...
  <div className="flex items-center justify-between px-6 py-4">
    ...
    <div className="flex items-center gap-1">
      ...
      <svg width="29" height="13" viewBox="0 0 29 13" fill="none">
        <path
          opacity="0.35"
          d="M4.81268 0.5H21.8127C23.7457 0.5 25.3127 2.067 25.3127 4V9C25.3127 10.933 23.7457 12.5 21.8127 12.5H4.81268C2.87969 12.5 1.31268 10.933 1.31268 9V4C1.31268 2.067 2.87969 0.5 4.81268 0.5Z"
          stroke="white"
        />
        <path
          opacity="0.4"
          d="M26.8127 5V9.22034C27.6617 8.86291 28.2139 8.0314 28.2139 7.11017C28.2139 6.18894 27.6617 5.35744 26.8127 5Z"
          fill="white"
        />
        <path
          d="M2.81268 4C2.81268 2.89543 3.70811 2 4.81268 2H21.8127C22.9173 2 23.8127 2.89543 23.8127 4V9C23.8127 10.1046 22.9173 11 21.8127 11H4.81268C3.70811 11 2.81268 10.1046 2.81268 9V4Z"
          fill="white"
        />
      </svg>
    </div>
