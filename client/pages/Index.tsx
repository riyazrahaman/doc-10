...
const Header = () => (
  <div className="flex items-center justify-between px-4 sm:px-6 md:px-8 lg:px-12 py-2 md:py-4">
    <div className="flex items-center gap-2 md:gap-3">
      ...
      <div>
        <p className="text-sm md:text-base text-medical-text-medium">
          Welcome Back
        </p>
        <p className="text-base md:text-lg font-medium text-medical-text-dark">
          Andrew Smith
        </p>
      </div>
    </div>
...
const CategoryCard = ({
  ...
  <div className="flex flex-col items-center gap-1 p-2 md:p-3 lg:p-4 rounded-2xl bg-medical-bg min-w-[64px] md:min-w-[80px] lg:min-w-[96px] hover:bg-medical-primary-lighter transition-colors cursor-pointer">
    ...
    <span className="text-xs md:text-sm font-semibold text-medical-text-medium text-center">
      {label}
    </span>
  </div>
);
  ...
  <div className="bg-medical-bg-light border border-[#F4F4F6] rounded-2xl p-4 md:p-6 flex flex-col gap-4 hover:shadow-lg transition-shadow">
    <div className="flex items-start gap-2 md:gap-3">
      ...
      <div className="flex-1">
        <div className="flex items-center justify-between">
          <div>
            <p className="text-medical-text-dark font-semibold text-sm md:text-base">
              {name}
            </p>
            <p className="text-medical-text-light text-sm md:text-base">
              {specialty} | {hospital}
            </p>
          </div>
          <Heart
            className={`w-5 h-5 md:w-6 md:h-6 cursor-pointer hover:scale-110 transition-transform ${isFavorite ? "fill-medical-favorite text-medical-favorite" : "text-medical-favorite"}`}
          />
        </div>
        <div className="flex items-center justify-between mt-2">
          <div className="flex items-center gap-1">
            <span className="text-medical-text-dark text-sm md:text-base">
              {rating}
            </span>
            <Star className="w-4 h-4 md:w-5 md:h-5 fill-yellow-400 text-yellow-400" />
          </div>
    ...
    <Link
      to={`/doctor/${id}`}
      className="bg-medical-primary-light text-medical-primary font-semibold text-sm md:text-base py-3 md:py-4 px-4 md:px-6 rounded-full hover:bg-medical-primary hover:text-white transition-colors text-center"
    >
      Book Appointment
    </Link>
  </div>
...
const BottomNav = () => {
  ...
  const NavItem = ({
    ...
    >
      <Icon
        className={`w-6 h-6 md:w-7 md:h-7 ${isActive ? "text-white" : "text-blue-200"}`}
      />
      <span
        className={`text-xs md:text-sm ${isActive ? "text-white font-semibold" : "text-blue-200"}`}
      >
        {label}
      </span>
    </Link>
...
const HeartIcon = () => (
  <svg width="28" height="28" viewBox="0 0 28 28" fill="none">
    <path
      d="M14 19.8332V19.8332C14 17.1916 14 15.8708 13.5425 14.8385C13.0059 13.6282 12.0384 12.6606 10.828 12.1241C9.79574 11.6665 8.47494 11.6665 5.83333 11.6665H3.5"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
    ...
    />
    <path
      d="M15.1667 7V7C15.1667 5.067 16.7337 3.5 18.6667 3.5H21"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
    ...
    />
    <path
      d="M8.16669 11.6665H14C16.5773 11.6665 18.6667 13.7558 18.6667 16.3332V16.3332"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
...
const KidneyIcon = () => (
  <svg width="28" height="28" viewBox="0 0 28 28" fill="none">
    <path
      d="M14 14V14C16.6416 14 17.9624 14 18.9946 14.4575C20.205 14.9941 21.1726 15.9616 21.7091 17.172C22.1667 18.2043 22.1667 19.5251 22.1667 22.1667V24.5"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
    />
    <path
      d="M14 14H15.1667C16.7163 14 17.4911 14 18.1292 13.8402C20.0382 13.362 21.5287 11.8715 22.0068 9.96256C22.1667 9.32447 22.1667 8.54965 22.1667 7V7"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
    />
    <path
      d="M13.5333 15.6917L14.8314 16.6652C16.4059 17.8461 16.9921 19.9365 16.2611 21.7639C15.6001 23.4164 13.9987 24.5 12.2188 24.5C7.40506 24.5 3.5 20.5977 3.5 15.7839V12.1406C3.5 7.36853 7.36853 3.5 12.1406 3.5C13.9573 3.5 15.58 4.63653 16.2008 6.34387L16.3094 6.64242C17.0165 8.58711 16.3682 10.7655 14.7128 12.0071L13.5333 12.8917C13.0927 13.2222 12.8333 13.7408 12.8333 14.2917C12.8333 14.8425 13.0927 15.3612 13.5333 15.6917Z"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
...
const StomachIcon = () => (
  <svg width="28" height="28" viewBox="0 0 28 28" fill="none">
    <path
      d="M24.5 12.621V9.33317C24.5 8.71394 24.5 8.40433 24.4658 8.1444C24.2295 6.34947 22.8171 4.93703 21.0221 4.70072C20.7622 4.6665 20.4526 4.6665 19.8334 4.6665C19.2141 4.6665 18.9045 4.6665 18.6446 4.70072C16.8496 4.93703 15.4372 6.34947 15.2009 8.1444C15.1667 8.40433 15.1667 8.71394 15.1667 9.33316V13.9998C15.1667 15.9328 13.5997 17.4998 11.6667 17.4998C9.73369 17.4998 8.16669 19.0668 8.16669 20.9998C8.16669 22.9328 9.73369 24.4998 11.6667 24.4998H12.6212C13.7469 24.4998 14.3097 24.4998 14.7841 24.4574C19.924 23.9974 23.9976 19.9239 24.4576 14.7839C24.5 14.3095 24.5 13.7467 24.5 12.621Z"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
    />
    <path
      d="M9.33331 3.5V3.5C9.33331 5.20744 9.33331 6.06116 9.58969 6.74233C9.99544 7.82039 10.8463 8.6712 11.9243 9.07696C12.6055 9.33333 13.4592 9.33333 15.1666 9.33333V9.33333"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
    />
    <path
      d="M3.5 24.5V24.5C3.5 22.567 5.067 21 7 21H8.16667"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
...
const LungIcon = () => (
  <svg width="28" height="28" viewBox="0 0 28 28" fill="none">
    ...
    />
    <path
      d="M16.3333 10.2998V19.25C16.3333 19.3274 16.3333 19.3661 16.3338 19.3988C16.3692 21.5567 18.11 23.2975 20.2679 23.3328C20.3006 23.3333 20.3393 23.3333 20.4166 23.3333C20.494 23.3333 20.5327 23.3333 20.5654 23.3328C22.7233 23.2975 24.4641 21.5567 24.4994 19.3988C24.5 19.3661 24.5 19.3274 24.5 19.25V12.9749C24.5 12.1702 24.5 11.7679 24.425 11.3862C24.3225 10.8642 24.117 10.3679 23.8204 9.92637C23.6035 9.60348 23.319 9.31899 22.75 8.75L21.9665 7.9665C21.3476 7.34766 20.5083 7 19.6331 7C17.8107 7 16.3333 8.47738 16.3333 10.2998Z"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
    />
    <path
      d="M14 2.3335V9.3335C14 11.2665 15.567 12.8335 17.5 12.8335V12.8335C19.433 12.8335 21 14.4005 21 16.3335V16.9168"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
    />
    <path
      d="M14 2.3335V9.3335C14 11.2665 12.433 12.8335 10.5 12.8335V12.8335C8.567 12.8335 7 14.4005 7 16.3335V16.9168"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
...
const BrainIcon = () => (
  <svg width="28" height="28" viewBox="0 0 28 28" fill="none">
    ...
    />
    <path
      d="M14 4.6665V5.83317C14 5.93221 14 5.98173 13.9984 6.02359C13.9546 7.18759 13.0211 8.12111 11.8571 8.16493C11.8152 8.1665 11.7657 8.1665 11.6667 8.1665V8.1665"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
    />
    <path
      d="M7 17.5H8.16667C8.26571 17.5 8.31523 17.5 8.35709 17.5016C9.52108 17.5454 10.4546 18.4789 10.4984 19.6429C10.5 19.6848 10.5 19.7343 10.5 19.8333V19.8333"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
    />
    <path
      d="M7 10.5V10.5C7 10.599 7 10.6486 7.00158 10.6904C7.04539 11.8544 7.97892 12.7879 9.14291 12.8318C9.18477 12.8333 9.23429 12.8333 9.33333 12.8333V12.8333"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
    />
    <path
      d="M21 10.5V7C21 6.84525 21 6.76788 20.9974 6.70247C20.9291 4.96429 19.5357 3.57086 17.7975 3.50257C17.7321 3.5 17.6547 3.5 17.5 3.5C17.3453 3.5 17.2679 3.5 17.2025 3.50257C15.4643 3.57086 14.0709 4.96429 14.0026 6.70247C14 6.76788 14 6.84525 14 7V21C14 21.1547 14 21.2321 14.0026 21.2975C14.0709 23.0357 15.4643 24.4291 17.2025 24.4974C17.2679 24.5 17.3453 24.5 17.5 24.5C17.6547 24.5 17.7321 24.5 17.7975 24.4974C19.5357 24.4291 20.9291 23.0357 20.9974 21.2975C21 21.2321 21 21.1547 21 21V17.5C21.1547 17.5 21.2321 17.5 21.2975 17.4974C23.0357 17.4291 24.4291 16.0357 24.4974 14.2975C24.5 14.2321 24.5 14.1547 24.5 14C24.5 13.8453 24.5 13.7679 24.4974 13.7025C24.4291 11.9643 23.0357 10.5709 21.2975 10.5026C21.2321 10.5 21.1547 10.5 21 10.5Z"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
    />
    <path
      d="M14 4.6665V5.83317C14 5.93221 14 5.98173 14.0016 6.02359C14.0454 7.18759 14.9789 8.12111 16.1429 8.16493C16.1848 8.1665 16.2343 8.1665 16.3333 8.1665V8.1665"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
    />
    <path
      d="M21 17.5H19.8333C19.7343 17.5 19.6848 17.5 19.6429 17.5016C18.4789 17.5454 17.5454 18.4789 17.5016 19.6429C17.5 19.6848 17.5 19.7343 17.5 19.8333V19.8333"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
    />
    <path
      d="M21 9.3335V10.5002C21 10.5992 21 10.6487 20.9984 10.6906C20.9546 11.8546 20.0211 12.7881 18.8571 12.8319C18.8152 12.8335 18.7657 12.8335 18.6667 12.8335V12.8335"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
...
const MentalIcon = () => (
  <svg width="28" height="28" viewBox="0 0 28 28" fill="none">
    ...
    />
    <path
      d="M11.6667 9.3335V9.3335C13.5997 9.3335 15.1667 10.9005 15.1667 12.8335V14.0002"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
...
const LiverIcon = () => (
  <svg width="28" height="28" viewBox="0 0 28 28" fill="none">
    <path
      d="M16.3333 13.3539V9.91683C16.3333 7.66167 18.1615 5.8335 20.4166 5.8335H20.8455C22.8638 5.8335 24.5 7.46965 24.5 9.48794C24.5 10.1503 24.32 10.8002 23.9792 11.3681L21.868 14.8869C21.3295 15.7844 20.3596 16.3335 19.3129 16.3335C17.6673 16.3335 16.3333 14.9995 16.3333 13.3539Z"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
    />
    <path
      d="M12.6136 19.6257L9.01689 21.681C8.45973 21.9994 7.82913 22.1668 7.18742 22.1668C5.15092 22.1668 3.5 20.5159 3.5 18.4794V12.2502C3.5 11.2437 3.5 10.7405 3.56773 10.3196C3.93324 8.04791 5.71441 6.26674 7.98609 5.90122C8.407 5.8335 8.91023 5.8335 9.91667 5.8335C10.9231 5.8335 11.4263 5.8335 11.8472 5.90122C14.1189 6.26674 15.9001 8.04791 16.2656 10.3196C16.3333 10.7405 16.3333 11.2437 16.3333 12.2502V13.216C16.3333 14.3691 16.3333 14.9457 16.2249 15.4753C15.9918 16.6131 15.3937 17.6437 14.5214 18.4106C14.1154 18.7675 13.6148 19.0536 12.6136 19.6257L12.6136 19.6257Z"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
    />
    <path
      d="M16.3333 24.5002L16.3333 17.5002C16.3333 15.5672 14.7663 14.0002 12.8333 14.0002V14.0002C10.9003 14.0002 9.33331 12.4332 9.33331 10.5002V9.3335"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
    />
    <path
      d="M16.3333 24.5L16.3333 15.1667C16.3333 12.5893 18.4227 10.5 21 10.5V10.5"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
      ...
      <div className="flex-1 pb-16 md:pb-20 lg:pb-24">
        ...
        <div className="px-4 sm:px-6 md:px-8 lg:px-12 py-4 md:py-6 lg:py-8">
          <div className="flex items-center justify-between mb-4 md:mb-6">
            <h2 className="text-lg md:text-xl lg:text-2xl font-bold text-medical-text-dark">
              Categories
            </h2>
            <span className="text-sm md:text-base text-medical-primary hover:underline cursor-pointer">
              See all
            </span>
          </div>
