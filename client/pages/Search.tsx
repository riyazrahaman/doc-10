...
const DoctorCard = ({
  ...
  <Link
    to={`/doctor/${id}`}
    className="block bg-medical-bg-light border border-[#F4F4F6] rounded-2xl p-4 md:p-6 hover:shadow-lg transition-shadow cursor-pointer"
  >
      ...
      <div className="flex items-start gap-2 md:gap-3">
        ...
        <div className="flex-1">
          <div className="flex items-center justify-between">
            ...
            <button onClick={(e) => e.preventDefault()} className="p-1">
              <Heart
...
const LiverIcon = () => (
  <svg width="28" height="28" viewBox="0 0 28 28" fill="none">
    ...
    />
    <path
      d="M16.3333 24.5002L16.3333 17.5002C16.3333 15.5672 14.7663 14.0002 12.8333 14.0002V14.0002C10.9003 14.0002 9.33333 12.4332 9.33333 10.5002V9.3335"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
          ...
          <div className="px-4 sm:px-6 md:px-8 lg:px-12 py-6">
            ...
            {filteredDoctors.length > 0 ? (
              ...
              <div className="text-center py-12">
                ...
                <h3 className="text-lg font-semibold text-medical-text-dark mb-2">
                  No doctors found
                </h3>
                <p className="text-medical-text-medium">
