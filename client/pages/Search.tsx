...
const LiverIcon = () => (
  <svg width="28" height="28" viewBox="0 0 28 28" fill="none">
    ...
    <path d="M16.3333 24.5002L16.3333 17.5002C16.3333 15.5672 14.7663 14.0002 12.8333 14.0002V14.0002C10.9003 14.0002 9.33333 12.4332 9.33333 10.5002V9.3335" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
